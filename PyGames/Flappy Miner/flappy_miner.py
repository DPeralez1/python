# When the space bar is pressed, out miner jumps, else he is falling
# Every pipe that passes is at a random position
# Score increses as the miner passes more pipes
# If you hit a pipe, you lose
# * Think about how I can use Lists
...
class Pipe:
    ...
    def draw_pipe(self):
        draw.rect(screen, (255, 255, 255), self.top_rect)
        draw.rect(screen, (255, 255, 255), self.bottom_rect)
...
display.set_caption("Flappy Miner")
clock = time.Clock()
background = transform.scale(image.load("./Pygames/Flappy Miner/background.jpg"), (WIDTH, HEIGHT))

miner = Miner("./Pygames/Flappy Miner/miner.png", 100, 300, 10)
